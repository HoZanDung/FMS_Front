        ...
        <el-col :span="8">
          <el-form ref="form" :model="form" :rules="rules" label-width="100px">
            ...
            <el-form-item label="紧急联系人:" prop="contactPerson">
              <el-input v-model="form.contactPerson" placeholder="请输入内容" style="width: 300px;"></el-input>
            </el-form-item>
            <el-form-item label="银行:" prop="bank">
              <el-input v-model="form.bank" placeholder="请输入内容" style="width: 300px;"></el-input>
            </el-form-item>
            <el-form-item label="银行账户:" prop="bankAccount">
              <el-input v-model="form.bankAccount" placeholder="请输入内容" style="width: 300px;"></el-input>
            </el-form-item>
            <el-form-item>
    ...
    methods: {
      ...
      on_submit_form(){
        this.$refs.form.validate((valid) => {
          ...
          this.$fetch.api_supplier.update(this.$route.params.id, this.form)
            .then(() => {
